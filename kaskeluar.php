            ...
            <div class="table-responsive">
                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $sql = mysqli_query($conn, "SELECT * FROM kas WHERE jenis_kas = 'keluar' ORDER BY id_kas DESC");
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="standard-modalLabel">Update Kas Keluar</h4>
                                                ...
                                                <div class="modal-body">
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group mb-2">
                                                            <input type="submit" value="Simpan" name="updateKasKeluar" class="btn btn-primary">
                                                        </div>
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button type="submit" name="deleteKasKeluar" class="btn btn-danger" data-bs-dismiss="modal">Delete</button>
                                                    </form>
                                                </div>
                                            </div><!-- /.modal-content -->
                                        </div><!-- /.modal-dialog -->
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Kas Keluar</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post">
                    ...
                    <div class="form-group mb-2">
                        <input type="submit" value="Simpan" name="addKasKeluar" class="btn btn-primary">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
